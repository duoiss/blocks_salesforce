include: "_contact.view.lkml"
include: "_user.view.lkml"
include: "_campaign.view.lkml"
...
view: account {
  ...
  dimension: market_segment {
    ...
    case: {
      when: {
        sql: ${employee_bucket} = 'Personal' ;;
        label: "Personal"
      }

      when: {
        sql: ${employee_bucket} IN ('2-10','11-50','51-500') ;;
        label: "VSB"
      }

      when: {
        sql: ${employee_bucket} = '501-2500' ;;
        label: "SMB"
      }

      when: {
        sql: ${employee_bucket} IN ('2501-5000','5001-10000') ;;
        label: "Mid-Market"
      }

      when: {
        sql: ${employee_bucket} = '10000+' ;;
        label: "Enterprise"
      }
...
view: opportunity {
  ...
  #    sql: ${account.created_date} ;;
  #}

  #dimension_group: close {
  #    type: time
  #    timeframes: [date, week, month, time, raw]
  #    sql: ${account.close_date_c} ;;
  #}
